...
const translations = {
  en: {
    ...
    home: "Home",
    upload_uploading: "Uploading to R2...",
    upload_idle: "Click or drag files to upload",
    upload_subtitle: "Support for images, documents, and archives.",
    all_files: "All Files",
  ...
  zh: {
    ...
    refresh: "刷新",
    home: "首页",
    upload_uploading: "正在上传到 R2...",
    upload_idle: "点击或拖拽文件上传",
    upload_subtitle: "支持图片、文档和压缩包。",
    all_files: "所有文件",
  ...
  ja: {
    ...
    refresh: "更新",
    home: "ホーム",
    upload_uploading: "R2にアップロード中...",
    upload_idle: "クリックまたはドラッグしてアップロード",
    upload_subtitle: "画像、ドキュメント、アーカイブに対応しています。",
    all_files: "すべてのファイル",
